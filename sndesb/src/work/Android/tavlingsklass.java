...
public class tavlingsklass implements Comparable<tavlingsklass> {
...
*/
	...
	public tavlingsklass copy(){
		tavlingsklass copy = new tavlingsklass();
...
*/
 	public int compareTo(tavlingsklass another) {
