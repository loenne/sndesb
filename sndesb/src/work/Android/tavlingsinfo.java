...
public class tavlingsinfo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tavlingsinfo);
...
/*		getArr = new Runnable() {
		...
		thread.start();
		m_ProgressDialog = ProgressDialog.show(tavlingsinfo.this,"Please wait...", "Retreiving data...",true);
*/
