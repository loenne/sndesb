			...
			if (fetchOk) {
				...
				for (organisation org : organisations){
					...
					if (org.getOrganisationTypeId().equals("2")) {
						...
						String stof = "Stockholms Orienteringsförbund";
...
//		defKlubbIndex = 0;
   	...
   	public class MyOnItemSelectedListener1 implements OnItemSelectedListener 
   	{
   	    public void onItemSelected(AdapterView<?> parent,
			...
			// Log.e("XTRACTOR","onItemSelected1 Selected pos : " + pos + "som är : " + parent.getItemAtPosition(pos).toString() + " och id:" + oforbundid.get(pos) );
 ...
 //       	boolean commaplaced = false;
	...
	public void myKlubbSearchClickHandler(View view) {
		switch (view.getId()) {
			...
			case R.id.sokval:
			{	
				Log.e("XTRACTOR","myKlubbSearchClickHandler klubbid" + mySelKlubbId + " som är : " + mySelKlubb );
